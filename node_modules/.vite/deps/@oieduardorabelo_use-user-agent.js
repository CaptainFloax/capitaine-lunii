...
// node_modules/@oieduardorabelo/use-user-agent/dist/use-user-agent.esm.js
...
function useUserAgent(uastring) {
  ...
  var _React$useState = (0, import_react.useState)(null), state = _React$useState[0], setState = _React$useState[1];
  (0, import_react.useEffect)(function() {
    var didRun = true;
    try {
      var uaParser = new import_ua_parser_js.UAParser();
...
//# sourceMappingURL=@oieduardorabelo_use-user-agent.js.map
